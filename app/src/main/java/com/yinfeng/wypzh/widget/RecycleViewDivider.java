 ...
 * <p>
 * 普通示例代码：
 * RecycleViewDivider lamaDivider = new RecycleViewDivider(
 * mContext, LinearLayoutManager.HORIZONTAL, ContextUtils.dip2px(mContext, 27), mContext.getResources().getColor(android.R.color.white));
 */
...
public class RecycleViewDivider extends RecyclerView.ItemDecoration {
     ...
     * @param dividerColor  分割线颜色 R.color.xx
     */
