...
public class BadgeView extends AppCompatTextView {
    ...
    private static final int DEFAULT_VIEW_SIZE = 12;

    private void init() {
        int size = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, DEFAULT_VIEW_SIZE, getResources().getDisplayMetrics());
...
//                            Gravity.RIGHT | Gravity.TOP);
            LayoutParams layoutParams = new LayoutParams(size, size, Gravity.RIGHT | Gravity.TOP);

//            layoutParams.leftMargin = dip2Px(0);
...
//        setBackGround(12, Color.parseColor("#a3321b"));
//        setBackGround(Color.parseColor("#a3321b"));
    ...
    public void setBackGround(int bgColor) {
        ContextUtils.setBackgroundCompat(this, ContextUtils.getOvalShapeDrawable(0, bgColor));
    }
    ...
    public void setTargetView(View target) {
        ...
        if (target.getParent() instanceof FrameLayout) {
            ((FrameLayout) target.getParent()).setClipChildren(false);
