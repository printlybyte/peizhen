...
public class SickAdapter extends BaseQuickAdapter<SickBean, BaseViewHolder> {
    private int space;
    private int spanNum;
    private int itemWidth;

    public SickAdapter(Context context, @Nullable List<SickBean> data) {
    ...
    @Override
    protected void convert(BaseViewHolder helper, SickBean item) {
