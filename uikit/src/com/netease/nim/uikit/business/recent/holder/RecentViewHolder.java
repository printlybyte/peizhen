...
//        bottomLine.setVisibility(getAdapter().isLastDataItem(position) ? View.VISIBLE : View.GONE);
        if ((recent.getTag() & RecentContactsFragment.RECENT_TAG_STICKY) == 0) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                holder.getConvertView().setBackgroundResource(R.drawable.ripple_white_solid_corner2_new);
            } else {
                holder.getConvertView().setBackgroundResource(R.drawable.shape_white_solid_corner_small_new);
            }
...
//            holder.getConvertView().setBackgroundResource(R.drawable.nim_recent_contact_sticky_selecter);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                holder.getConvertView().setBackgroundResource(R.drawable.ripple_white_solid_corner2_new_top);
            } else {
                holder.getConvertView().setBackgroundResource(R.drawable.shape_white_solid_corner_small_new_top);
            }
        }
    }
