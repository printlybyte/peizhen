...
public class PermissionTipDialogNew extends BaseDialog<PermissionTipDialogNew> {
    private Context mContext;
    private String title, content;
    private TextView tvTitle, tvContent, tvConfirm;

    public PermissionTipDialogNew(Context context, String permissionName) {
        super(context);
        mContext = context;
...
//        widthScale(0.85f);
        View view = LayoutInflater.from(mContext).inflate(R.layout.dialog_permissiontip_new, null);
