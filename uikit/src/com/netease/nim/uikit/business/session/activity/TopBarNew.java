...
public class TopBarNew extends LinearLayout {
    LinearLayout llLeft;
    ...
    public TopBarNew(Context context) {
        this(context, null);
    }


    public TopBarNew(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TopBarNew(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context) {
        View parent = LayoutInflater.from(context).inflate(R.layout.topbar_new, null);
