...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    private void requestBuddyInfo() {
        mTopBarNew.setTopLeftTxtWithArrow(UserInfoHelper.getUserTitleName(sessionId, SessionTypeEnum.P2P));
...
//        setSubTitle(detailContent);
        mTopBarNew.setTopLeftTxtWithArrow(detailContent);
    }
    ...
    protected void showCommandMessage(CustomNotification message) {
        ...
        try {
            ...
            if (id == 1) {
                // 正在输入
                mTopBarNew.setTopCenterTxt("对方正在输入...");
                mTopBarNew.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        mTopBarNew.setTopCenterTxt("");
                    }
                }, 1500);
