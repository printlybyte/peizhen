...
public class PickImageHelper {
     ...
     * @param option
     */
    public static void pickTakePhote(final Context context, final int requestCode, final PickImageOption option) {
        if (context == null) {
            return;
        }
    ...
    public static void pickTakeGallery(final Context context, final int requestCode, final PickImageOption option) {
        if (context == null) {
            return;
        }
