...
public class PreviewImageFromCameraActivity extends UI {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.nim_preview_image_from_camera_activity_new);

        mTopBarNew = findViewById(R.id.topbarnew);
        mTopBarNew.setTopLeftTxtWithArrow("拍摄");
...
//        setToolBar(R.id.toolbar, options);
    ...
    private void initActionBar() {
        ...
        mTopBarNew.setTopRightTxt(getResources().getString(R.string.recapture));
